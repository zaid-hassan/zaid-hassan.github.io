...
const Crosshair: React.FC<CrosshairProps> = ({
  ...
  useEffect(() => {
    ...
    const glitchTargets: NodeListOf<HTMLSpanElement> = containerRef?.current
      ? containerRef.current.querySelectorAll(".glitch-target")
      : document.querySelectorAll(".glitch-target");

    glitchTargets.forEach((link) => {
